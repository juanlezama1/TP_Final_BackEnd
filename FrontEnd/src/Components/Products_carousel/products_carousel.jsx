...
return (
  <Container fluid className='p-0'>
    <Carousel style={{backgroundColor: '#5eb0df', height: '500px'}} autoplay autoplaySpeed={800} dotPosition='left' className='d-flex flex-column justify-content-center text-center align-items-center'>
