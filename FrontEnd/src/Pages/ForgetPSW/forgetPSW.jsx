...
import 'react-toastify/dist/ReactToastify.css';
  ...
  const ForgetPSW = () => {
    ...
    return (
      <Container fluid className='d-flex flex-column justify-content-center' style={{backgroundColor: '#5eb0df'}}>
        <div className='row'>
            <div className="col-12">
              <Main_Titles title={"Correo Electrónico Enviado!"}/>
              <div className="d-flex flex-column align-items-center">
                  <img src={'/images/email.png'} alt="imagen_email" className='main_image' />
