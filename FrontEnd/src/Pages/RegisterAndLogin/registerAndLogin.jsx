                ...
                <div className="row" style={{backgroundColor: '#5eb0df'}}>
                    ...
                    <div className="col-8">
                        ...
                        <div className="row" style={{marginTop: '10px'}}>
                            <div className="col-8 d-flex flex-row justify-content-center" style={{height: '200px', wordWrap: 'break-word'}}>
                            ...
                            <div className="col-4 d-flex flex-column justify-content-center" style={{height: '200px'}}>
